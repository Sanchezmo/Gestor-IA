...
def thirdparty_to_dolibarr(data: dict[str, Any], is_client: bool = True, is_supplier: bool = False) -> dict[str, Any]:
    ...
    direct_fields = {
        "name", "name_alias", "email", "phone", "phone_mobile", "fax",
        "address", "zip", "town", "state_id", "country_id",
        "default_lang", "fk_parent", "iban", "bic", "skype",
        "twitter", "facebook", "linkedin", "shipping_method_id",
        "payment_term_id", "bar_code", "note_private", "note_public",
    }
...
def product_to_dolibarr(data: dict[str, Any]) -> dict[str, Any]:
    ...
    direct_fields = {
        "ref", "label", "description", "note", "type", "status",
        "price", "price_ttc", "price_base_type", "tva_tx",
        "weight", "weight_units", "length", "surface", "volume",
        "barcode", "fk_product_type", "fk_default_vat_code",
    }
